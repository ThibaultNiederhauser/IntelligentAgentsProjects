...
public class AuctionFuturSimple implements AuctionBehavior {
    ...
    public Long askPrice(Task task) {
        ...
        //    this.currentVariables.selectInitialSolution();
        //}
        TrueMarginal = computeMarginalCost(task, this.currentVariables); //TODO speed up because same computations as BEST PLAN IF WIN
